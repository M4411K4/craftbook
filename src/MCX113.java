...
public class MCX113 extends BaseIC {
    ...
    public void think(ChipState chip) {
        ...
        if (!id.isEmpty())
        {
        	...
        	{
        		Vector[] inVec = new Vector[3];
        		inVec[0] = Util.getWallSignBack(pt, -1);
        		inVec[1] = Util.getWallSignSide(pt, 1);
        		inVec[2] = Util.getWallSignSide(pt, -1);
        		
        		turnOn = Redstone.isHighBinary(inVec[0], true) ||
        	...
        	if(turnOn && !airwaves.containsKey(id))
        	{
				...
				Location loc = new Location(bpos.getX(), bpos.getY(), bpos.getZ());
