...
public class MCX250 extends BaseIC {
    /**
    ...
    public String validateEnvironment(int worldType, Vector pos, SignText sign) {
        ...
        if(line3.isEmpty())
        {
        	return "3rd line must contain Particle type";
        }
        ...
        if(ParticleType.getParticle(sblock[0]) == null)
        {
        ...
        if(sblock.length > 1)
        {
        	...
        	{
        		return "Particle data must be a number.";
        	}
        }
    ...
    public void think(ChipState chip) {
        ...
        ParticleType particleType = ParticleType.getParticle(sblock[0]);
        
        if(particleType == null || !particleType.allowed)
        	return;
        ...
        else if(particleType == ParticleType.BLOCK)
        {
        	data = 3; //dirt
        }
